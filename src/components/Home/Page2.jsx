    ...
    <div className="container mx-auto p-4">
      <div>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          <li className="px-4">
            <div className="w-full bg-red-100 rounded-md border-slate-500  shadow-xl border p-3">
          ...
          <li className="px-4">
            <div className="w-full bg-green-100 rounded-md border-slate-500 border shadow-xl p-3">
                <h1 className="text-center font-bold text-slate-600 flex justify-center items-center gap-2">
